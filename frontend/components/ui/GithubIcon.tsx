/**
 * GitHub's official octocat mark. lucide-react no longer ships brand/logo
 * icons (dropped for trademark reasons), so this is kept as the one
 * deliberate custom SVG in the icon system — everything else uses Lucide.
 */
